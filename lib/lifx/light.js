 ...
 * @param {Function} callback a function to accept the data
 */
Light.prototype.getGroup = function(callback) {
  if (typeof callback !== 'function') {
    throw new TypeError('LIFX light getGroup method expects callback to be a function');
  }
  var packetObj = packet.create('getGroup', {}, this.client.source);
  packetObj.target = this.id;
  var sqnNumber = this.client.send(packetObj);
