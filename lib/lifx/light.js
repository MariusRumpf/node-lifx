...
/**
 * Requests the current state of the bulb
 * @param {Function} callback a function to accept the data
 */
Light.prototype.getState = function(callback) {
  if (typeof callback !== 'function') {
    throw new TypeError('LIFX bulb getState method expects callback to be a function');
  }
 ...
 * @param {Function} callback a function to accept the data
 */
Light.prototype.get = util.deprecate(function(callback) {
  ...
  this.getState(callbackHandler);
}, '`Light.get` is deprecated, please use `Light.getState` instead');

/**
 * Requests hardware info from the bulb
 * @param {Function} callback a function to accept the data with error and
 *                   message as parameters
 */
Light.prototype.getHardware = function(callback) {
  if (typeof callback !== 'function') {
    throw new TypeError('LIFX bulb getHardwareVersion method expects callback to be a function');
  }
...
/**
 * Requests used version from the microcontroller unit of the bulb
 * @param {Function} callback a function to accept the data
 */
Light.prototype.getFirmwareVersion = function(callback) {
  if (typeof callback !== 'function') {
    throw new TypeError('LIFX bulb getFirmwareVersion method expects callback to be a function');
  }
...
/**
 * Requests infos from the microcontroller unit of the bulb
 * @param {Function} callback a function to accept the data
 */
...
/**
 * Requests wifi infos from for the bulb
 * @param {Function} callback a function to accept the data
 */
...
/**
 * Requests used version from the wifi controller unit of the bulb (wifi firmware version)
 * @param {Function} callback a function to accept the data
 */
