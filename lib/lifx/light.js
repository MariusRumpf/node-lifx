...
Light.prototype.color = function(hue, saturation, brightness, kelvin, duration) {
  ...
  if (typeof brightness !== 'number' || brightness < constants.HSBK_MINIMUM_B || brightness > constants.HSBK_MAXIMUM_BRIGHTNESS) {
    throw new RangeError('LIFX bulb color method expects brightness to be a number between ' +
      constants.HSBK_MINIMUM_B + ' and ' + constants.HSBK_MAXIMUM_BRIGHTNESS
    );
  }
