...
/**
 * Requests the current info for the bulb
 * @param {Function} callback a function to accept the data
 */
Light.prototype.get = function(callback) {
  if (typeof callback !== 'function') {
    throw new TypeError('LIFX bulb get method expects callback to be a function');
  }
  var packetObj = packet.create('getLight', {}, this.client.source);
  packetObj.target = this.id;
  var sqnNumber = this.client.send(packetObj);
  this.client.addMessageHandler('stateLight', function(msg) {
