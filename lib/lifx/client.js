...
Client.prototype.init = function(options, callback) {
  ...
  if (opts.source !== '') {
    if (typeof opts.source === 'string' && /^[0-9a-z]{8}$/.test(opts.source)) {
      this.source = opts.source;
    } else {
      throw new RangeError('LIFX source must be 8 chars lowercase or digits');
    }
  }
 ...
 */
Client.prototype.findLights = function(identifier) {
